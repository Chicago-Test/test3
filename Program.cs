...
namespace VBAStreamDecompress
{
    internal class Program
    {
        ...
        static public (int, int, int, int) CopyTokenHelp(int decompressedCurrent, int decompressedChunkStart)
        ...
        static public byte[] decompress_stream(byte[] compressedContainer)
        {
            //"""
        ...
        private static void archiveVBAcodes(string filename)
        {
