...
#Add-Type -Assembly "$PSScriptRoot\bin\Debug\net8.0\TreeSitter.dll"
#Add-Type -Assembly ".\TreeSitter.dll"
Import-Module ".\TreeSitter.dll"
...
#$cp.ReferencedAssemblies.Add("$PSScriptRoot\bin\Debug\net8.0\TreeSitter.dll")
#$cp.ReferencedAssemblies.Add("E:\temp\test-tree-sitter\test-treesitter\pws_inline_test\TreeSitter.dll")

#$cp.ReferencedAssemblies.Add("E:\temp\test-tree-sitter\test-treesitter\pws_inline_test\TreeSitter.dll")
[void]$cp.ReferencedAssemblies.Add(".\TreeSitter.dll")
[void]$cp.ReferencedAssemblies.Add("netstandard.dll") #Very important!!!
[void]$cp.ReferencedAssemblies.Add("System.Core.dll")

#$cp.ReferencedAssemblies.Add("System.dll")
#$cp.ReferencedAssemblies.Add("System.Runtime.dll")
#$cp.ReferencedAssemblies.Add("mscorlib.dll")
#$cp.ReferencedAssemblies.Add([System.Object].Assembly.Location)

Add-Type -TypeDefinition $source -CompilerParameters $cp

$array = @("E:\temp\cloc\uncomment\src","-config", "config.txt")
[TreeSitterTest.Test]::Main($array)
